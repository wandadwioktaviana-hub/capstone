...
<div class="page-header">
    <h1 class="page-title">Input Barang Produksi</h1>
    <div>
        <ol class="breadcrumb">
            <li class="breadcrumb-item text-gray">Hasil Produksi</li>
            <li class="breadcrumb-item active" aria-current="page">Input Barang Produksi</li>
        </ol>
    </div>
</div>
<!-- PAGE-HEADER END -->
