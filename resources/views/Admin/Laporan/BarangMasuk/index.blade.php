...
<div class="page-header">
    <h1 class="page-title">History Barang Masuk</h1>
    <div>
        <ol class="breadcrumb">
            <li class="breadcrumb-item text-gray">History</li>
            <li class="breadcrumb-item active" aria-current="page">History Barang Masuk</li>
        </ol>
    </div>
</div>
<!-- PAGE-HEADER END -->
