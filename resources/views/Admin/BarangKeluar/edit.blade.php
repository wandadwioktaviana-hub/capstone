                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bkkodeU" class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    function checkFormU() {
        ...
        if (bkkode == "") {
            validasi('Kode BK wajib di isi!', 'warning');
            $("input[name='bkkodeU']").addClass('is-invalid');
            setLoadingU(false);
            return false;
        } else if (tglkeluar == "") {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if (xhr.responseJSON && xhr.responseJSON.errors) {
                    ...
                    var first = Object.keys(msgs)[0];
                    validasi(msgs[first][0], 'warning');
                } else {
                    validasi('Terjadi kesalahan saat menyimpan perubahan', 'error');
                }
            }
        });
    }
    ...
    function resetValidU() {
        $("input[name='bkkodeU']").removeClass('is-invalid');
